...
# from mapbook.crud import hello, read_users, add_user, update_user, remove_user
...
class User:
    def __int__(self, imie, nazwisko, postow, lokalizacja):
        self.imie = imie
...
ramka_mapa.grid(row=2, column=0, padx=50, pady=20, columnspan=2)
